 ...
 */
namespace Devopensource\Tickets\Setup;
...

{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()
            ...
            getTable('devopensource_tickets_ticket'))
            ...
            ->addIndex(
                $installer->getIdxName('devopensource_tickets_ticket',
                    ['customer_id']),
                ['customer_id']
            )

            ->addForeignKey(
                $installer->getFkName('devopensource_tickets_ticket',
            ...
            ->setComment('Devopensource Tickets Ticket');
