...
class Close extends \Devopensource\Tickets\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        if ($ticket && $ticket->getId()) {
            try {
                $ticket->setStatus(\Devopensource\Tickets\Model\Ticket::STATUS_CLOSED);
                $ticket->save();
                ...
                $transport = $this->transportBuilder
                    ->setTemplateIdentifier($this->scopeConfig->getValue('devopensource_tickets/email_template/customer', $storeScope))
                    ->setTemplateOptions(
                        [
